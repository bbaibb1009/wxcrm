...
<html>
  <head>
	...
	$(document).ready(function(){
		loadMenuTreeForAdmin(${command.wadId});
		//getDeptName2List("deptName2");
	});
	</script>
  </head>
  ...
  <body>
  	...
  	<div class="content">
   	...
   	<f:form action="${pageContext.request.contextPath}/admin/updAdmin" onsubmit="return false;">
  	<f:hidden path="wadId"/>
  	<f:hidden path="wadPwdMd5"/>
  	<f:hidden path="wadLogindate"/>
  	<f:hidden path="menuIds"/>
  	<f:hidden path="wadUsername_Q"/>
  	<f:hidden path="wadName_Q"/>
    ...
    <table cellpadding="0" cellspacing="0" border="1" width="100%">
    	<tr>
    		...
    		<td width="75%"><f:input path="wadUsername" readonly="true"/></td>
    	</tr>
    	<tr>
    		<td>重设密码</td>
				...
				<tr>
					<td align="center">
						<f:select path="roleIds2" multiple="true" size="20" cssStyle="width: 250px;">
							<f:options items="${roleList0}" itemValue="wroRoleId" itemLabel="wroRoleName"/>
						</f:select>
					</td>
					<td align="center">
						<img src="${pageContext.request.contextPath}/view/image/goright.gif" onclick="changeRole(document.getElementById('roleIds2'), document.getElementById('roleIds'), ${command.wadId});" title="添加角色" style="cursor: pointer;"/>
						<br/><br/>
						<img src="${pageContext.request.contextPath}/view/image/goleft.gif" onclick="changeRole(document.getElementById('roleIds'), document.getElementById('roleIds2'), ${command.wadId});" title="删除角色" style="cursor: pointer;"/>
					</td>
					<td align="center">
						<f:select path="roleIds" multiple="true" size="20" cssStyle="width: 250px;">
							<f:options items="${roleList1}" itemValue="wroRoleId" itemLabel="wroRoleName"/>
						</f:select>
					</td>
				</tr>
			</table>
