...
<html>
  <head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/view/sys/js/dept.js?v=${applicationScope.sysStartUpTime}"></script>
	...
	$(document).ready(function(){
		loadMenuTree("${pageContext.request.contextPath}/menu/getMenuTreeForRole/0/${command.wroRoleId}");
	});
	</script>
  </head>
  ...
  <body>
  	...
  	<f:form action="${pageContext.request.contextPath}/role/updRole" onsubmit="return false;">
  	<f:hidden path="wroRoleId"/>
  	<f:hidden path="menuIds"/>
  	<f:hidden path="adminIds"/>
  	<f:hidden path="roleName_Q"/>
    ...
    <table cellpadding="0" cellspacing="0" border="1" width="100%">
    	...
    	<tr>
    		<td colspan="2">
    			<input type="button" value="修改" onclick="addRoleSubmit();"/>&nbsp;&nbsp;
