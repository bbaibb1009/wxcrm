...
<html>
  <head>
	...
	$(document).ready(function(){
		loadMenuTree("${pageContext.request.contextPath}/shopmenu/getShopMenuTreeForRole/0/${command.wsrRoleId}");
	});
	</script>
  </head>
  ...
  <body>
  	...
  	<f:form action="${pageContext.request.contextPath}/shoprole/updShopRole" onsubmit="return false;">
    ...
    <table cellpadding="0" cellspacing="0" border="1" width="100%">
    	<tr>
    		...
    		<td width="70%"><f:input path="wsrRoleName" maxlength="50"/></td>
    	</tr>
    	<tr>
    	...
    	<tr>
    		<td>备注：</td>
    		<td><f:textarea path="wsrRoleDesc" cols="50" rows="5"/></td>
