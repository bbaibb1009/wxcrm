	...
	<body>
		<div class="wrapper">
		  	...
		  	<div class="admin_right" id="adminRight">
		  		<div class="content">
			  	<f:form action="${pageContext.request.contextPath}/website/updWebsite" onsubmit="return false;">
			   	<f:hidden path="wcsId"/>
			    <table cellpadding="0" cellspacing="0" border="1" width="100%" >
			    	...
			    	<tr>
			    		...
			    		<td style="text-align:left;"><f:input path="wcsAppId" cssStyle="width:280px;"/></td>
			    	</tr>
			    	<tr>
			    		<td><font color="red"><b>*</b></font>AppSecret</td>
			    		<td style="text-align:left;"><f:input path="wcsAppSecret" cssStyle="width:280px;"/></td>
			    	</tr>
			    	<tr>
