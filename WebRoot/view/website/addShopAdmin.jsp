...
<html>
  ...
  <body>
  	...
  	<div class="content">
  	<f:form action="${pageContext.request.contextPath}/shopadmin/addShopAdmin" onsubmit="return false;">
  	<f:hidden path="menuIds"/>
    <table cellpadding="0" cellspacing="0" border="1" width="100%">
    	<tr>
    		<td width="25%"><font color="red"><b>*</b></font>用户名：</td>
    		<td width="75%"><f:input path="wsaUsername" maxlength="20" title="用户名只能包含字母、数字或下划线"/></td>
    	</tr>
    	<tr>
    	...
    	<tr>
    		...
    		<td><input type="password" id="wsaPwd2" name="wadPwd2"/></td>
    	</tr>
    	<tr>
				...
				<tr>
					<td align="center">
						<f:select path="roleIds2" multiple="true" size="20" cssStyle="width: 250px;">
							<f:options items="${roleList}" itemValue="wsrRoleId" itemLabel="wsrRoleName"/>
						</f:select>
					</td>
					<td align="center">
