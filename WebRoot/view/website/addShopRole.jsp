...
<html>
  <head>
	...
	$(document).ready(function(){
		loadMenuTree("${pageContext.request.contextPath}/shopmenu/getShopMenuTreeForRole/0/-1");
	});
	</script>
  </head>
  ...
  <body>
  	...
  	<f:form action="${pageContext.request.contextPath}/shoprole/addShopRole" onsubmit="return false;">
