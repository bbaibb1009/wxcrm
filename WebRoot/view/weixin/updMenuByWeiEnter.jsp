  ...
  <body>
  	...
  	<f:form action="${pageContext.request.contextPath}/weixinmenu/addMenuByEnter" onsubmit="return false;">
  		...
  		<table cellpadding="0" cellspacing="0" border="1" width="100%">
  			<tr class ="trNotSubBtn"><th width="15%">应用名称</th>	<td width="85%" style="text-align:left;">${weiEnter.wecAppName}</td></tr>
	    	<tr class ="trNotSubBtn"><th width="15%">应用APPID</th>	<td width="85%" style="text-align:left;"><f:input path="wmuAppId" /><f:hidden path="wmuAppSecret"/></td></tr>
	    	<tr class ="trNotSubBtn"><th width="15%">JSON串</th>		<td width="85%" style="text-align:left;"><f:input cssStyle="width:100%;" path="wmuJson" /></td></tr>
	    	<tr class ="trNotSubBtn"><th width="15%">备注</th>		<td width="85%" style="text-align:left;"><f:textarea path="wmuDesc" /></td></tr>
	    	...
	    	<tr class ="trNotSubBtn">
	    		<th width="15%">key</th>
	    		<td width="85%" style="text-align:left;"><input type="text" name="iptKey_1" id="iptKey_1" value=""/></td>
	    	</tr>
	    	<tr class ="trNotSubBtn" >
	    		<th width="15%">url</th>
	    		<td width="85%" style="text-align:left;"><input type="text" name="iptUrl_1" id="iptUrl_1" value=""/></td>
	    	</tr>
	    	<tr class ="trSubBtn">
	    		<th width="15%">小按钮1</th>
	    		<td width="85%" style="text-align:left;">
