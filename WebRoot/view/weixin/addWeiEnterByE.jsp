	...
	<body>
		<div class="wrapper">
		  	...
		  	<div class="admin_right" id="adminRight">
		  		<div class="content">
			  	<f:form action="${pageContext.request.contextPath}/weixin/addWeiEnterByE/${command.wecEnterId}" onsubmit="return false;">
			    <table cellpadding="0" cellspacing="0" border="1" width="100%" >
			    	<tr>
			    		<td><font color="red"></font>所属企业：</td>
			    		<td style="text-align:left;">
			    			${command.wecEnterName_Q}<f:hidden path="wecEnterId"/>
			    		</td>
			    	</tr>
			    	<tr>
			    		<td><font color="red"></font>客户类型：</td>
			    		<td style="text-align:left;">
				    		<f:hidden path="wecCusType"/>
				    		<c:if test="${command.wecCusType=='1'}">内部应用</c:if>
				    		<c:if test="${command.wecCusType=='2'}">商用</c:if>
