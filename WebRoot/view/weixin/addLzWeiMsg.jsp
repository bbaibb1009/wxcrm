	...
	<body>
		<div class="wrapper">
		  	...
		  	<div class="admin_right" id="adminRight">
		  		<div class="content">
			  	<f:form action="${pageContext.request.contextPath}/weixinmsg/addLzWeiMsg" onsubmit="return false;">
			    <table cellpadding="0" cellspacing="0" border="1" width="100%" >
			    	<tr>
			    		<td width="10%"><font color="red">*</font>加密类型：</td>
			    	...
			    	<tr id="type_1" style="display:none;">
			    		...
			    		<td width="75%" style="text-align:left;">
			    			...
			    			<table id="tbTuwen"  cellpadding="0" cellspacing="0" border="1" width="100%" >
			    				<tr>
			    					<td  style="text-align:left;" colspan="4"><input type="button" onclick="javascript:addNewsMsg();" value="添加"></td>
			    				</tr>
			    				<tr class="newsMsgTh">
			    	...
			    	<tr id="type_2" style="display:none;">
			    		...
			    		<td width="75%" style="text-align:left;">
			    			<f:textarea path="wmgContent"></f:textarea>
			    		</td>
			    	</tr>
			    	<tr>
