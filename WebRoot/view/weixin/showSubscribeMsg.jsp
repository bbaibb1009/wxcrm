...
<html>
  ...
  <body>
  	...
  	<f:form action="${pageContext.request.contextPath}/weixinmsg/querySubscribeMsg" onsubmit="return false;">
  		<table cellpadding="0" cellspacing="0" border="1" width="100%">
	    	<tr>
	    		...
	    		<td style="width:16%;">
	    			...
	    			<input type="button" value="添加" onclick="javascript:addSubscribeMsg();"/>
	    		</td>
	    	</tr>
    	</table>
